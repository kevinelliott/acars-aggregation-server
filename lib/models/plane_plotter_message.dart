...
class PlanePlotterMessage extends BasicMessage {
  ...
  PlanePlotterMessage(source, this.mode, this.tail, this.ack, this.label,
      this.blockId, this.messageNumber, this.flightNumber, this.text)
      : super(source) {}
}
